...
public class MD4  {
    ...
    public static CryptoBuffer encode(CryptoBuffer message) {
        MD4 md4 = new MD4();
        md4.engineUpdate(message.toRawBytes(), 0, message.length());
        return new CryptoBuffer(md4.engineDigest());
    }

    public static CryptoBuffer encode(CryptoBuffer message, int[] regs, long len) {
        MD4 md4 = new MD4();
        md4.engineReset(regs, len);
        md4.engineUpdate(message.toRawBytes(), 0, message.length());
        return new CryptoBuffer(md4.engineDigest());
    }
...
//...........................................................................
    ...
    private void engineReset(int[] regs, long len) {
        for (int i = 0; i < 4; i++) {
            context[i] = regs[i];
        }
        count = len;
